...
#define ENDPOINT_CLEAR_PORT_FEATURE     0x01 | ( (USB_DIR_OUT | USB_TYPE_STANDARD | USB_RECIP_ENDPOINT) <<8 )
...
//------------------------------------------------------------------------------------
//Get Config
#define USB_GET_CONFIG_GET_MAX_LUN		1

//Set Config
#define USB_SET_CONFIG_INIT				0
#define USB_SET_CONFIG_HCD_DEVICE_D		1
#define USB_SET_CONFIG_URB_CONFIG_D		2
#define USB_SET_CONFIG_HCD_SET_ADDR		3
#define USB_SET_CONFIG_URB_SET_CONFIG	4
#define USB_SET_CONFIG_HCD_BULK_READ	5
#define USB_SET_CONFIG_HCD_BULK_WRITE	6
#define USB_SET_CONFIG_URB_BULK_READ	7
#define USB_SET_CONFIG_SET_CURRENT_LUN	8
...
//cyg_uint8 			usb_host_enumeration(void);
