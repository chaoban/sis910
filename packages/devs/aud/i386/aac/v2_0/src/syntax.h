...
char GASpecificConfig(bitfile *lld, mp4AudioSpecificConfig *mp4ASC,
                        program_config *pce);
...
unsigned char reordered_spectral_data(AACDecHandle hDecoder, ic_stream *ics, bitfile *ld, short *spectral_data);
#ifdef DRM
