...
static void tns_decode_coef(unsigned char order, unsigned char coef_res_bits, unsigned char coef_compress,
                            unsigned char *coef, real_t *a);
static void tns_ar_filter(real_t *spectrum, unsigned short size, char inc, real_t *lpc,
                          unsigned char order);
static void tns_ma_filter(real_t *spectrum, unsigned short size, char inc, real_t *lpc,
                          unsigned char order);
...
void tns_decode_frame(ic_stream *ics, tns_info *tns, unsigned char sr_index,
                      unsigned char object_type, real_t *spec, unsigned short frame_len)
{
    unsigned char w, f, tns_order;
    char inc;
    short size;
...
void tns_encode_frame(ic_stream *ics, tns_info *tns, unsigned char sr_index,
                      unsigned char object_type, real_t *spec, unsigned short frame_len)
{
    unsigned char w, f, tns_order;
    char inc;
