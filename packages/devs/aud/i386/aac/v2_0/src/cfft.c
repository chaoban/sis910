...
static void passf3(const unsigned short ido, const unsigned short l1, const complex_t *cc,
                   complex_t *ch, const complex_t *wa1, const complex_t *wa2, const char isign);
...
void cfftf1(unsigned short n, complex_t *c, complex_t *ch,
                   const unsigned short *ifac, const complex_t *wa, const char isign);
...
static void cfftf1pos(unsigned short n, complex_t *c, complex_t *ch,
                             ...
                             const char isign)
{
    ...
    for (k1 = 2; k1 <= nf+1; k1++)
    {
        ...
        case 2:
            if (na == 0)
                passf2pos((const unsigned short)ido, (const unsigned short)l1, (const complex_t*)c, ch, &wa[iw]);
            else
                passf2pos((const unsigned short)ido, (const unsigned short)l1, (const complex_t*)ch, c, &wa[iw]);
...
static void cfftf1neg(unsigned short n, complex_t *c, complex_t *ch,
                             const unsigned short *ifac, const complex_t *wa,
                             const char isign)
{
    unsigned short i;
...
{
    cfftf1pos(cfft->n, c, cfft->work, (const unsigned short*)cfft->ifac, (const complex_t*)cfft->tab, +1);
}
