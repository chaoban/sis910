 ...
 */
static
unsigned long scale_rational(unsigned long numer, unsigned long denom, unsigned long scale)
{
...
signed long mad_timer_count(mad_timer_t timer, enum mad_units units)
{
	switch (units)
	{
		...
		case MAD_UNITS_75_FPS:
			return timer.seconds * (signed long) units + (signed long) scale_rational(timer.fraction, MAD_TIMER_RESOLUTION, units);
