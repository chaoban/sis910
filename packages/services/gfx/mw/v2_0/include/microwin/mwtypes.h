...
#define MWMODE_ROTATION_90      26
#define MWMODE_ROTATION_270     27
#define MWMODE_ROTATION_180     28
#define MWMODE_ROTATION_HMIRROR 29
#define MWMODE_ROTATION_VMIRROR 30
#define MWMODE_SRC_TRANSLUCENCY 31

#define	MWMODE_MAX		31
...
#define MWRGB(r,g,b)	MWARGB(0,(r),(g),(b))
...
#define	MWROP_ROTATION_90	MWMODE_TO_ROP(MWMODE_ROTATION_90)
#define	MWROP_ROTATION_270	MWMODE_TO_ROP(MWMODE_ROTATION_270)
#define	MWROP_ROTATION_180	MWMODE_TO_ROP(MWMODE_ROTATION_180)
#define	MWROP_ROTATION_HMIRROR	MWMODE_TO_ROP(MWMODE_ROTATION_HMIRROR)
#define	MWROP_ROTATION_VMIRROR	MWMODE_TO_ROP(MWMODE_ROTATION_VMIRROR)
#define MWROP_SRC_TRANSLUCENCY	MWMODE_TO_ROP(MWMODE_SRC_TRANSLUCENCY)
