...
#if !(defined(DOS_DJGPP) || defined(__PACIFIC__) || defined(DOS_TURBOC))
...
void	GdRotateBlit(PSD dstpsd, MWCOORD dstx, MWCOORD dsty, MWCOORD width,
		MWCOORD height,PSD srcpsd,MWCOORD srcx,MWCOORD srcy,long rop);		
...
void	GdStretchImage(PMWIMAGEHDR src, MWCLIPRECT *srcrect, PMWIMAGEHDR dst,
		MWCLIPRECT *dstrect);
void	GdStretchImageToFit( int id, MWCOORD width, MWCOORD height);		
