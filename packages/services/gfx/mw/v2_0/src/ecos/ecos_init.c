...
ecos_nx_init(CYG_ADDRWORD data)
{
  ...
  //  test_file_io();
...
#ifdef CYGPKG_IO_FILEIO
    {
        ...
        //if (0 == stat("/penguin.bmp", &stat_data)) {
            //GrDrawImageFromFile(mainwid, gct, 0, 0, si.cols, si.rows, "/microwin.bmp", 0);
            //GrDrawImageFromFile(mainwid, gct, 0, 0, si.cols, si.rows, "/penguin.bmp", 0);
        //}
