...
GsWpUnrealizeWindow(GR_WINDOW *wp, GR_BOOL temp_unmap)
{
	...
	GR_WINDOW	*childwp = NULL;	/* child window */
...
GsWpDestroyWindow(GR_WINDOW *wp)
{
	...
	GR_EVENT_CLIENT	*ecp = NULL;		/* selections for window */
...
{
	GR_WINDOW	*wp = NULL;		/* current window pointer */
...
{
	GR_PIXMAP	*pp = NULL;		/* current pixmap pointer */
...
{
	GR_GC		*gcp = NULL;		/* current graphics context pointer */
...
{
	GR_REGION	*regionp = NULL;	/* current region pointer */
...
{
	GR_WINDOW	*wp = NULL;		/* found window */
        GR_PIXMAP       *pp = NULL;            /* found pixmap */
	GR_GC		*gcp = NULL;		/* found graphics context */
	GR_FONT		*fontp = NULL;
	GR_REGION	*regionp = NULL;	/* user clipping region */
	MWCLIPREGION	*reg = NULL;
	PMWFONT		pf;
...
GsFindVisibleWindow(GR_COORD x, GR_COORD y)
{
	...
	GR_WINDOW	*retwp = NULL;		/* returned window */
...
GsCheckCursor(void)
{
	GR_WINDOW	*wp = NULL;		/* window cursor is in */
...
{
	GR_WINDOW	*wp = NULL;		/* newest window for mouse */
