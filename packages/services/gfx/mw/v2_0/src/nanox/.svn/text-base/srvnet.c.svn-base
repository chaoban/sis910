...
static void
GrStretchImageToFitWrapper(void *r)
{
	nxStretchImageToFitReq *req = r;

	GrStretchImageToFit(req->imageid, req->width, req->height);
}
...
#define GrStretchImageToFitWrapper GrNotImplementedWrapper
...
struct GrFunction {
	...
	/* 125 */ {GrStretchImageToFitWrapper, "GrStretchImageToFit"},
};
...
GrShmCmdsFlushWrapper(void *r)
{
	...
	nxReq 		*pr = NULL;
	int 		length;
	unsigned char 	*do_req = NULL, *do_req_last = NULL;
...
{
	GR_WINDOW     * wp = NULL, *nwp = NULL;
	GR_PIXMAP     * pp = NULL, *npp = NULL;
	GR_GC 	      * gp = NULL, *ngp = NULL;
	GR_REGION     * rp = NULL, *nrp = NULL;
	GR_FONT       * fp = NULL, *nfp = NULL;
	GR_CURSOR     *	cp = NULL, *ncp = NULL;
	GR_EVENT_CLIENT *ecp = NULL, *necp = NULL;
	GR_EVENT_CLIENT *pecp = NULL;
	GR_EVENT_LIST	*evp = NULL;
	GR_GRABBED_KEY	*kp = NULL, *nkp = NULL;
#if MW_FEATURE_IMAGES
	GR_IMAGE      * ip = NULL, *nip = NULL;
#endif
#if MW_FEATURE_TIMERS
	GR_TIMER      * tp = NULL, *ntp = NULL;
#endif
