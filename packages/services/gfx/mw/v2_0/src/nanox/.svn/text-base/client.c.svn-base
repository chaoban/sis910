...
{
	GR_EVENT_CLIENT_DATA *event = NULL;
...
{
	EVENT_LIST *elp = NULL, *prevelp = NULL;
	GR_EVENT event;
...
{
	nxUnionRectWithRegionReq *req = NULL;
...
{
	nxSetGCGraphicsExposureReq *req = NULL;
...
{
	nxNewPolygonRegionReq	*req = NULL;
	long			size;
	GR_REGION_ID		region;
...
{
	nxSetGCForegroundPixelValReq *req = NULL;
...
{
	nxSetGCBackgroundPixelValReq *req = NULL;
...
{
	nxSetGCLineAttributesReq *req = NULL;
...
{
	nxSetGCUseBackgroundReq *req = NULL;
...
{
	nxGetFontListReq *req = NULL;
	char *tmpstr = NULL;
	GR_FONTLIST **flist = NULL;
	int num, len, i;
...
{
	nxDrawImageFromFileReq *req = NULL;
...
{
	nxLoadImageFromFileReq *req = NULL;
	GR_IMAGE_ID		imageid;
...
void
GrStretchImageToFit(GR_IMAGE_ID imageid, GR_SIZE width, GR_SIZE height )
{
	nxStretchImageToFitReq *req = NULL;
...
sendImageBuffer(const void *buffer, int size)
{
  ...
  nxImageBufferAllocReq *alloc = NULL;
  nxImageBufferSendReq *send = NULL;
...
{
  nxLoadImageFromBufferReq *req = NULL;
  int bufid;
  GR_IMAGE_ID imageid;
...
{
  nxDrawImageFromBufferReq *req = NULL;
	int bufid;
...
{
	nxSetSystemPaletteReq *req = NULL;
...
{
	nxSetScreenSaverTimeoutReq *req = NULL;
...
{
	nxSetSelectionOwnerReq *req = NULL;
	char *p;
	int len;
...
{
	nxGetSelectionOwnerReq *req = NULL;
	UINT16 textlen;
	GR_CHAR c;
	GR_WINDOW_ID wid;
...
{
	nxRequestClientDataReq *req = NULL;
...
{
	nxSetBackgroundPixmapReq *req = NULL;
...
{
	GR_FONT_ID result;
	nxCreateFontFromBufferReq *req = NULL;
	int bufid;
