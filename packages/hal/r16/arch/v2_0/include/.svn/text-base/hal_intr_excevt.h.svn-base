...
//--------------------------------------------------------------------------
// R16 exception vectors. It is in 90002610[31:16].
// Chaoban test
#define CYGNUM_HAL_VECTOR_GPIO 					 0x00010000	// 0
#define CYGNUM_HAL_VECTOR_TIMER					 0x00020000 // 1
#define CYGNUM_HAL_VECTOR_RTC					 0x00040000	// 2
#define CYGNUM_HAL_VECTOR_SPI					 0x00080000	// 3
#define CYGNUM_HAL_VECTOR_INITIAL				 0x00100000 // 4
#define CYGNUM_HAL_VECTOR_VLD					 0x00200000 // 5
#define CYGNUM_HAL_VECTOR_ILF					 0x00400000 // 6
#define CYGNUM_HAL_VECTOR_PCI					 0x00800000 // 7
#define CYGNUM_HAL_VECTOR_USB					 0x01000000 // 8
#define CYGNUM_HAL_VECTOR_OTG					 0x02000000 // 9
#define CYGNUM_HAL_VECTOR_2D					 0x04000000 //10
#define CYGNUM_HAL_VECTOR_CRT                    0x08000000 //11
#define CYGNUM_HAL_VECTOR_GATEWAY                0x10000000 //12
#define CYGNUM_HAL_VECTOR_DMAC                   0x20000000 //13
#define CYGNUM_HAL_VECTOR_PERITOP                0x40000000 //14
#define CYGNUM_HAL_VECTOR_IR					 0x80000000 //15
...
#define CYGNUM_HAL_INTERRUPT_GPIO              0
#define CYGNUM_HAL_INTERRUPT_TMU0_TUNI0        1
#define CYGNUM_HAL_INTERRUPT_REAL_TIME_CLCOK   2
#define CYGNUM_HAL_INTERRUPT_SPI               3
#define CYGNUM_HAL_INTERRUPT_INITIAL           4
#define CYGNUM_HAL_INTERRUPT_VLD               5
#define CYGNUM_HAL_INTERRUPT_RESERVED_ILF      6
#define CYGNUM_HAL_INTERRUPT_PCI               7
#define CYGNUM_HAL_INTERRUPT_USB_DEVICE        8               
#define CYGNUM_HAL_INTERRUPT_ONTHEGO           9
#define CYGNUM_HAL_INTERRUPT_2D                10
#define CYGNUM_HAL_INTERRUPT_CRT               11
#define CYGNUM_HAL_INTERRUPT_GATEWAY           12
#define CYGNUM_HAL_INTERRUPT_DMAC              13
#define CYGNUM_HAL_INTERRUPT_PERITOP           14
#define CYGNUM_HAL_INTERRUPT_IR				   CYGNUM_HAL_INTERRUPT_PERITOP
#define CYGNUM_HAL_INTERRUPT_I2C			   CYGNUM_HAL_INTERRUPT_PERITOP
#define CYGNUM_HAL_INTERRUPT_UART			   CYGNUM_HAL_INTERRUPT_PERITOP

#ifndef CYGNUM_HAL_ISR_MAX
# define CYGNUM_HAL_ISR_MAX                  CYGNUM_HAL_INTERRUPT_IR
#endif

#define CYGNUM_HAL_ISR_MIN                   CYGNUM_HAL_INTERRUPT_GPIO
...
#define HAL_CLOCK_INITIALIZE( _period_ )                                    \
    CYG_MACRO_START                                                         \
    register cyg_uint32 _tstr_;                                             \
                                                                            \
    /* Disable timer while programming it. */                               \
    HAL_READ_UINT32(CYGARC_REG_CNT0_CTL, _tstr_);                           \
    _tstr_ &= ~CYGARC_REG_CTL_ENABLE;                                       \
    HAL_WRITE_UINT32(CYGARC_REG_CNT0_CTL, _tstr_);                          \
                                                                            \
    /* Set counter registers. */                                            \
    HAL_WRITE_UINT32(CYGARC_REG_CNT0_PRESET, (_period_));                   \
                                                                            \
    /* start counter registers. */                                          \
    HAL_WRITE_UINT32(CYGARC_REG_CNT0_CTL, CYGARC_REG_CTL_ENABLE);           \
                                                                            \
    CYG_MACRO_END
...
#define HAL_CLOCK_RESET( _vector_, _period_ )                                 \
    CYG_MACRO_START                                                           \
                                                                              \
    HAL_WRITE_UINT32(CYGARC_REG_CNT0_LOAD, CYGARC_REG_LOAD_RELOAD);           \
                                                                              \
    CYG_MACRO_END
...
#define HAL_CLOCK_READ( _pvalue_ )                              \
    ...
    register cyg_uint32 _result_;                               \
                                                                \
    HAL_READ_UINT32(CYGARC_REG_CNT0_CUR, _result_);             \
                                                                \
