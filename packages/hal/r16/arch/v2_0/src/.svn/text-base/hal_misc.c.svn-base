...
#ifdef CYGSEM_HAL_STOP_CONSTRUCTORS_ON_FLAG	//chaoban test
...
hal_delay_us(int usecs)
{
    ...
    volatile unsigned char *tstr = (volatile unsigned char *)CYGARC_REG_CNT0_CTL;
    volatile unsigned long *tcnt = (volatile unsigned long *)CYGARC_REG_CNT0_CUR;
    volatile unsigned long *tcor = (volatile unsigned long *)CYGARC_REG_CNT0_PRESET;
