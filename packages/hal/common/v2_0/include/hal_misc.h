...
//#========= DDR-II =========#
#define CYG_HAL_DDRII

#if defined(CYG_HAL_CHIP_VERSION_910B) && defined(CYG_HAL_CHIP_PLATFORM_FPGA)
#define CYG_HAL_SIS910B //about new verion DC
#endif

#if defined(CYG_HAL_CHIP_VERSION_910A) && defined(CYG_HAL_CHIP_PLATFORM_REALCHIP)
#define __CHAOBAN_RC
#endif
...
#define __fila_remove_0620
#define __fila_malloc_align
#define __jerry_stdio_performance_tuning

#if defined(__CHAOBAN_RC) || defined(CYG_HAL_SIS910B)
