...
//      smdk2440_misc.c
//
//      HAL misc board support code for ARM9/SMDK2440
//
//==========================================================================
...
#define X_ARM_MMU_SECTION(abase,vbase,size,cache,buff,access)      \
    { int i; int j = abase; int k = vbase;                         \
      ...
      {                                                            \
        ARM_MMU_SECTION(0x30004000, j, k, cache, buff, access);      \
      }                                                            \
    }
...
hal_mmu_init(void)
{   
    unsigned long ttb_base = SMDK2440_SDRAM_PHYS_BASE + 0x4000;     //=0x30004000
    unsigned long i;
    ...
    memset((void *)0x30004000, 0, 0x4000); //ARM_FIRST_LEVEL_PAGE_TABLE_SIZE = 0x4000
    ...
    //   SFR_BASE_ADDRESS:       0x48000000, 512M  //???? Should be 384MB ??
    //   FLASH_BASE_ADDRESS:     0x80000000,   2M  //???? Should be 64MB ??
    ...
    X_ARM_MMU_SECTION(0x480,  0x480,  384,  ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW); // SFRs
    X_ARM_MMU_SECTION(0x300,  0x300,   64,  ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW); // Raw SDRAM
//    X_ARM_MMU_SECTION(0x190,  0x190,     2,  ARM_UNCACHEABLE, ARM_UNBUFFERABLE, ARM_ACCESS_PERM_RW_RW); /* Ethernet */
...
static void port_init(void)
{
    ...
    HAL_WRITE_UINT32(GPFCON, 0x5500);  //55aa
    ...
    HAL_WRITE_UINT32(GPHCON, 0x16faaa);
...
hal_clock_initialize(cyg_uint32 period)
{
    ...
    temp &= ~(0xff<<8);
    temp |= (CYGNUM_HAL_ARM_SMDK2440_TIMER_PRESCALE<<8);
...
hal_delay_us(cyg_int32 usecs)
{
    ...
    cyg_uint32 wait_ticks = (((PCLK/100000)*usecs)/CYGNUM_HAL_ARM_SMDK2440_TIMER_PRESCALE/2/10);
