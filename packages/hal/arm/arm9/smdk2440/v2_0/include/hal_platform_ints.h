...
// Description:  The interrupt details for the Samsung SMDK2440 are defined here.
// Usage:
...
// These are interrupts on the SMDK2440
...
#define CYGNUM_HAL_INTERRUPT_ETH        CYGNUM_HAL_INTERRUPT_EINT3
