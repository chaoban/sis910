...
#define S_FATFS_ATTRIB   (S_FATFS_RDONLY | S_FATFS_HIDDEN | S_FATFS_SYSTEM | \
                          S_FATFS_ARCHIVE)
#define S_FATFS_LONG_NAME (S_FATFS_RDONLY | S_FATFS_HIDDEN | S_FATFS_SYSTEM |\
                           S_FATFS_VOLUME)
#define S_FATFS_LONG_NAME_MASK  (S_FATFS_RDONLY | S_FATFS_HIDDEN |\
	       	S_FATFS_SYSTEM |S_FATFS_VOLUME|S_FATFS_DIR|S_FATFS_ARCHIVE)  
...
#define S_FATFS_ISLONG_NAME(__mode) ((__mode) & S_FATFS_LONG_NAME)
#define S_FATFS_ISLONG_NAME_MASK(__mode) ((__mode) & S_FATFS_LONG_NAME_MASK)
