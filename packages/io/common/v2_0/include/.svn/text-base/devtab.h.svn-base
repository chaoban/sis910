...
#ifdef CYGONCE_PKGCONF_HAL_SH_SIS910_H
#define ALIGN_USE_FUNC_PTR
#endif
...
typedef struct cyg_devtab_entry {
	...
	void*            (*func_ptr)(cyg_uint32 sizes);
#endif	
...
#ifdef ALIGN_USE_FUNC_PTR 
#define BLOCK_DEVTAB_ENTRY(_l,_name,_dep_name,_handlers,_init,_lookup,_priv,_func_ptr)  \
cyg_devtab_entry_t _l CYG_HAL_TABLE_ENTRY(devtab) = {                   \
   _name,                                                               \
   _dep_name,                                                           \
   _handlers,                                                           \
